        ...
        <form action="update.jsp" method="POST">
            ...
            <table>
                ...
                <tr>
                    <td>Phone Number:</td>
                    <td>
                        <input type="text" name="phone_Number" value="${emp.phone_Number}" required>
                    </td>
                </tr>
                <tr>
                    <td>Age:</td>
                    <td>
                        <input type="number" name="Age" value="${emp.Age}" required>
                    </td>
                </tr>
                <tr>
                    <td>Join Date:</td>
                    <td>
                        <input type="date" name="Join_Date" value="${emp.Join_Date}" required>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
